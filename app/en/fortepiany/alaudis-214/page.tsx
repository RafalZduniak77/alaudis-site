      ...
      <section className="bg-neutral-950 px-6 py-20 sm:px-10 lg:px-16">
        <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-3">
          <div className="rounded-[30px] border border-white/10 bg-white/[0.03] p-8">
            ...
            <p className="mt-5 leading-8 text-white/90">Ideal for spacious residences, private music rooms, boutique hotels and chamber stages where the instrument should be beautiful, present and projecting in sound.</p>
          </div>
          ...
          <div className="rounded-[30px] border border-white/10 bg-white/[0.03] p-8">
            ...
            <p className="mt-5 leading-8 text-white/90">It is best suited to modern premium interiors, classic apartments and representative rooms where the piano becomes the centre of the composition.</p>
          </div>
          ...
          <div className="rounded-[30px] border border-white/10 bg-gradient-to-br from-white/10 to-white/[0.03] p-8">
            ...
            <p className="mt-5 leading-8 text-white/90">Alaudis 214 preserves the visual class of a premium model while offering a larger tonal scale and a stronger stage personality.</p>
          </div>
        </div>
      </section>
